...
class DebuggerBase:
    ...
    def _init_train_transform(self):
        ...
        #     A.augmentations.geometric.resize.Resize(self.args.resize,self.args.resize, always_apply=True),
        #     A.augmentations.crops.transforms.RandomCrop(self.args.crop_size,self.args.crop_size, always_apply=True),
        #     ToTensorV2()
...
class LSTMDebugger(DebuggerBase):
    ...
    def _epoch_train(self):
        ...
        for i, (images, _, label, captions, prob) in tqdm(enumerate(self.train_data_loader), desc='Train'):
            ...
            # print(batch_stop_loss.data, batch_word_loss)
