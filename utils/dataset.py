...
if __name__ == '__main__':
    vocab_path = '../data/new_data/clean_subset_vocab.pkl'
    image_dir = '../../../scratch/datasets/iu-xray-Q1'
    caption_json = '../data/new_data/clean_subset_captions_full.json'
    file_list = '../data/new_data/subset_val_data.txt'
    batch_size = 6
    resize = 256
    crop_size = 224
