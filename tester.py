...
class CaptionSampler(object):
    def __init__(self, args):
        ...
        self.data_loader = self.__init_data_loader(self.args.file_list)
    ...
    def test(self):
        ...
        for i, (images, _, label, captions, prob) in tqdm(enumerate(self.data_loader),desc='Predicting'):
    ...
    def generate(self):
        ...
        for images, image_id, label, captions, _ in progress_bar:
            ...
            for i in range(self.args.s_max):
                ...
                sampled_ids = np.array(sampled_ids) * p_stop.cpu().numpy()
            ...
            # for id, array in zip(image_id, captions):
                ...
                # print(real_sentences[id], captions)

            for id, pred_tag, real_tag in zip(image_id, tags, label):
                results[id] =pred_sentences[id]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_list', type=str, default='./data/new_data/debugging_data.txt',
